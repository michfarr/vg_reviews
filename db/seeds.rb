...
Game.create(title: "Gears of War", category: xbox_games)
Game.create(title: "Halo", category: xbox_games)

Game.create(title: "Mortal Kombat", category: playstation_games)
Game.create(title: "Demon Souls", category: playstation_games)
Game.create(title: "Spyro the Dragon", category: playstation_games)

Game.create(title: "Risk", category: board_games)
Game.create(title: "Secret Hitler", category: board_games)
Game.create(title: "Settlers of Catan", category: board_games)
